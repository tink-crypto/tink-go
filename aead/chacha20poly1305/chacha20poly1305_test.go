...
func TestRegisterPrimitiveConstructor(t *testing.T) {
	...
	err := chacha20poly1305.RegisterPrimitiveConstructor(cb, internalapi.Token{})
	if err != nil {
	...
	key, err := chacha20poly1305.NewKey(secretdata.NewBytesFromData(make([]byte, 32), testonlyinsecuresecretdataaccess.Token()), 0x1234, params)
	if err != nil {
